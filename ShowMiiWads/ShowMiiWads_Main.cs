...
namespace ShowMiiWads
{
	public partial class ShowMiiWads_Main : Form
	{
		...
		public const string version = "Beta 1.5";
		...
		private void UpdateCheck(bool silentifno)
		{
			if (!version.Contains("Beta"))
			{
				try
				{
					...
					string newversion = GetVersion.DownloadString("https://github.com/jpmac26/showmiiwads/newversion.txt");
					...
					{
						string mes = string.Format(Messages[113], newversion, "https://github.com/jpmac26/showmiiwads");
