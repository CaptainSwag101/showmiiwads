...
namespace ShowMiiWads
{
    ...
    "visit:";
			...
			// linkLabel1
			// 
			this.linkLabel1.Location = new System.Drawing.Point(0, 195);
			this.linkLabel1.Name = "linkLabel1";
			this.linkLabel1.Size = new System.Drawing.Size(200, 14);
			this.linkLabel1.TabIndex = 5;
			this.linkLabel1.TabStop = true;
			this.linkLabel1.Text = "github.com/jpmac26/showmiiwads";
			...
			this.label5.Text = "Licensed under the terms of the GNU General Public License v3";
			...
			this.lbPlatform.Location = new System.Drawing.Point(0, 125);
			...
			this.label1.Text = "Maintained by CaptainSwag101";
